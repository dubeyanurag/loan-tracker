      ...
      if (!isNaN(amount) && amount > 0) {
        ...
        dispatch({
          ...
          payload: {
            loanId: loan.id,
            payment: {
              // id: '', // Removed, will be generated by reducer
              date: paymentDate, // Use potentially overridden date
              amount: amount,
              type: 'Prepayment',
              // principalPaid: amount, // Removed - will be calculated
              // interestPaid: 0, // Removed - will be calculated
              // balanceAfterPayment: 0, // Removed - will be calculated
